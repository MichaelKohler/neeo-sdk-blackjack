...
module.exports = class Game {
  ...
  deal(times, player) {
    ...
    for (let i = 0; i < times; i++) {
      ...
      console.log('New cards', cards.map((card) => {
  ...
  checkBlackjack(cards) {
    return this.deck.checkBlackjackPotential(cards) &&
      this.getScore(cards) === 21;
  }
  ...
  dealerFinishGame() {
    ...
    if (this.checkBlackjack(this.dealerCards)) {
